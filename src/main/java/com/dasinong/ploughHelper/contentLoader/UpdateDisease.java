...
public class UpdateDisease implements IUpdateDisease {
	/* (non-Javadoc)
	 * @see com.dasinong.ploughHelper.contentLoader.IUpdateDisease#run()
	 */
	@Override
	@Transactional
	public void run() {
	...
	/* (non-Javadoc)
	 * @see com.dasinong.ploughHelper.contentLoader.IUpdateDisease#processSubStageIds(java.lang.String)
	 */
	@Override
