...
public class GetLiveWeather {
	...
	public String getRealURL() throws NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException{
		String result;
		String urlkey = this.url+"?areaid="+this.areaId+"&type=rforecast7d&date="+date+"&appid="+this.app_id;
		...
		result = this.url+"?areaid="+this.areaId+"&type=rforecast7d&date="+date+"&appid="+this.short_app_id+"&key="+finalkey;
		System.out.println(result);
		return result;
	}
