...
public class SubScribeList implements Serializable{
	...
	public SubScribeList(Long ownerId, String targetName, String cellphone,
			String province, String city, String country, String district,
			double area, Long cropId, boolean isAgriWeather, boolean isNatAler,
